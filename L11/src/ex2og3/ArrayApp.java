...
public class ArrayApp {
    ...
    public static void main(String[] args) {
        ...
        int[] array2 = {3,0,9,5,5};
        tabel = metode.makeSum(array1, array2);
        System.out.println("Forvent: [7, 6, 16, 7, 8]");
        System.out.println("Aktuelt: " + Arrays.toString(tabel));
        System.out.println();

        int[] array3 = {2, 4, 6, 8, 10, 11};
        System.out.println("Ulige tal: " + metode.hasUneven(array3));
        // int[] tabel2 = { 78, 23, 1, 4, 65, 3, 87, 5, 12 };
        // metode.printArray(tabel2);
        //
        // System.out.println(metode.findMax(tabel2));

        System.out.println(metode.sumInt(array3));
    }
